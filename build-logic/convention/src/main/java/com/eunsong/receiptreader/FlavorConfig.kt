...
@Suppress("EnumEntryName")
enum class FlavorConfig(val dimension: FlavorDimension, val applicationIdSuffix: String? = null) {
...
fun configureFlavors(
    ...
    flavorConfigurationBlock: ProductFlavor.(flavor: FlavorConfig) -> Unit = {},
) {
    commonExtension.apply {
        ...
        productFlavors {
            FlavorConfig.values().forEach { niaFlavor ->
